...
<template>
  <footer class="py-12 bg-[#000000] border-t border-[#27272a]">
    <div class="max-w-6xl mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-6">
      ...
      <div class="flex items-center space-x-4">
        <a href="https://github.com" target="_blank"
           class="text-[#71717a] hover:text-white transition-colors"
           aria-label="GitHub">
        ...
        <button
          @click="scrollToTop"
          class="ml-2 p-2 rounded-md bg-[#18181b] hover:bg-[#27272a] text-[#a1a1aa] hover:text-white transition-colors cursor-pointer"
